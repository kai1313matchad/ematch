...
<!--
    ...
    <div class="container" >
        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3" style="background-color: #eee; padding: 25px 20px; border-radius: 7px; margin-top: 50px">
            ...
            <div id="input_signature" style="display: none; margin-top: 20px;">
                <form class="" method="POST" action="<?php echo base_url();?>Evisit/Visit/insertSign">
                    ...
                    <div style="margin-top: 10px; text-align: center;">
                        <div id="btnKonv">
                            <br>
                            <button type="button" class="btn btn-lg btn-block btn-success btn-refresh" id="btnSave">Konversi</button>
                            <br>
                        ...
                        <div id="btnReg" style="display: none; margin-top: 10px;">
                            <br>
                            <input type="submit" class="btn btn-lg btn-block btn-primary" value="Simpan">
...
function verifiCode() {
    $.post("<?php echo site_url('Evisit/Visit/matchVerificationCode')?>", { email_address : $("#email_address").val(), verification_code : $("#ver_code").val() }, function(data) { updateStatus(data); }, "json");
}
