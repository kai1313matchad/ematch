									...
									?>
										<tr>
											...
											<td style="text-align: center; color: black;">
												...
												<!-- mulai fungsi hapus laporan -->
												<?php if ($this->session->userdata('level') == 1) { ?>			
												<br>
												<button data-toggle="modal" data-target="#modalHapus<?= $u->id_tiang ?>" type="button" class="btn btn-danger btn-sm col-md-12">
												...
												<!-- Modal hapus -->
												<div class="modal fade" id="modalHapus<?php echo $u->id_tiang ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="padding-top: 100px;">
												  <div class="modal-dialog modal-lg" role="document">
												    <div class="modal-content">
												      ...
												      <div class="modal-body" style="background-color: #ce1e1e; color: white">
												        <h4>Yakin hapus laporan beserta foto-fotonya?</h4>
												      </div>
												      <div class="modal-footer">
															<form id="form_kpim" method="POST" action="<?php echo base_url();?>tiang/hapuslaporan/<?php echo $u->id_tiang?>">
