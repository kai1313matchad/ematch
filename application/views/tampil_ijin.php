	    ...
	    <div class="container-fluid"> 
	        ...
	        <div class="collapse navbar-collapse">
	            <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="<?php echo base_url(); ?>kpimmingguan/ijin">Ijin Karyawan</a></li>
...
?>
	<div class="container-fluid" style="max-width: 800px; background-color: rgba(204, 204, 204, 0.3); color: black; border:solid 4px #778899; border-radius: 15px;">
		...
		<div class="row">
			...
			<button type="button" id="simpanijin" name="input"  class="btn btn-primary col-lg-12 btn-block" data-toggle="modal" data-target="#myModal" style="font-family: 'Exo 2', sans-serif; margin-bottom: 10px"><span class="glyphicon glyphicon-floppy-save"></span> Simpan</button>
			</div>
