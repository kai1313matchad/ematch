...
<?php date_default_timezone_set('Asia/Jakarta'); ?>
	...
	<div class="container-fluid" style="max-width: 600px; background-color: #0c627b; color: white; border:solid 4px #63021c; border-radius: 15px;">

		<div class="row"> 
			<div class="col-sm-3"></div>
			<div class="col-sm-8 text-center" style="padding-top: 10px"><h4>Pilih Periode Report Tidak Input</h4></div>
		</div>
	
		<form id="form_kpim" action="<?php echo base_url();?>reportku/lihattdkinput/" method="POST">
		<div class="row">
			<div class="col-sm-3"> 
		...
		<div class="row">
			...
			<div class="col-sm-8 text-center" style="padding-bottom: 15px"> <button type="submit" name="input"  class="btn btn-danger col-sm-12" style="font-family: 'Exo 2', sans-serif;"><span class="glyphicon glyphicon-zoom-in"></span> Tampilkan</button>
